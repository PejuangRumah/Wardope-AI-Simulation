...
<div class="p-8">
	...
	<div class="mb-8">
		...
		<p class="text-gray-600 mt-1">Manage wardrobe item subcategories</p>
	</div>
	...
	<div class="bg-white rounded-lg border border-gray-200 p-6">
		<p class="text-gray-600">Master data management coming soon...</p>
		<p class="text-sm text-gray-500 mt-2">
			Subcategories: Shirt, Jeans, Sneakers, T-Shirt, Dress, etc.
		</p>
	</div>
</div>
