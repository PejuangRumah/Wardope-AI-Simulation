						...
						<div class="p-4 bg-white">
							...
							<div class="mb-4 p-3 bg-purple-50 border border-purple-200 rounded-lg">
								...
								<p class="text-xs text-purple-700">
									This system uses OpenAI's embeddings and GPT-4o to create intelligent outfit recommendations.
									The process takes 5-8 seconds and costs approximately Rp 150-200 per request.
								</p>
							</div>
							...
							<div class="space-y-3">
								...
								<div class="border border-gray-200 rounded-lg p-3 bg-gray-50">
									<div class="flex items-start gap-3">
										...
										<div class="flex-1">
											<h4 class="text-sm font-semibold text-gray-900 mb-1">CSV Parsing & Validation</h4>
											<p class="text-xs text-gray-600 mb-2">
												Parse uploaded CSV file and validate required fields (id, desc, category, subcategory, color).
											</p>
											<div class="flex items-center gap-4 text-xs">
												<span class="text-gray-500">⏱️ ~50ms</span>
												<span class="text-green-600 font-medium">✓ No API cost</span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="border border-blue-200 rounded-lg p-3 bg-blue-50">
									<div class="flex items-start gap-3">
										...
										<div class="flex-1">
											<h4 class="text-sm font-semibold text-gray-900 mb-1">Create Item Embeddings</h4>
											<p class="text-xs text-gray-600 mb-2">
												Convert each wardrobe item into a 1536-dimensional vector using <code class="px-1 py-0.5 bg-blue-100 rounded text-xs">text-embedding-3-small</code>.
											...
											<div class="flex items-center gap-4 text-xs">
												<span class="text-gray-500">⏱️ ~1-2s (86 items)</span>
												<span class="text-orange-600 font-medium">💰 $0.0001 USD (Rp 1.5)</span>
												<span class="text-purple-600 bg-purple-100 px-2 py-0.5 rounded">🔄 Cached 1 hour</span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="border border-blue-200 rounded-lg p-3 bg-blue-50">
									<div class="flex items-start gap-3">
										...
										<div class="flex-1">
											<h4 class="text-sm font-semibold text-gray-900 mb-1">Query Embedding</h4>
											<p class="text-xs text-gray-600 mb-2">
											...
											<div class="flex items-center gap-4 text-xs">
												<span class="text-gray-500">⏱️ ~200ms</span>
												<span class="text-orange-600 font-medium">💰 $0.00001 USD (Rp 0.15)</span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="border border-gray-200 rounded-lg p-3 bg-gray-50">
									<div class="flex items-start gap-3">
										...
										<div class="flex-1">
											<h4 class="text-sm font-semibold text-gray-900 mb-1">Semantic Search (Vector Similarity)</h4>
											<p class="text-xs text-gray-600 mb-2">
												Calculate cosine similarity between query and all items. Select top items per category to ensure variety.
											</p>
											<div class="p-2 bg-white border border-gray-200 rounded text-xs mb-2">
												...
												<div class="mt-1 text-gray-500 font-medium">Total: ~40-50 items sent to AI</div>
											</div>
											<div class="flex items-center gap-4 text-xs">
												<span class="text-gray-500">⏱️ ~100ms</span>
												<span class="text-green-600 font-medium">✓ No API cost</span>
											</div>
										</div>
									</div>
								...
								<div class="border border-green-200 rounded-lg p-3 bg-green-50">
									<div class="flex items-start gap-3">
										...
										<div class="flex-1">
											<h4 class="text-sm font-semibold text-gray-900 mb-1">GPT-4o Outfit Generation</h4>
											<p class="text-xs text-gray-600 mb-2">
												AI analyzes filtered items and creates 3-5 complete outfit combinations with reasoning.
												Uses structured output (JSON Schema) for consistent results.
											</p>
											<div class="p-2 bg-white border border-green-200 rounded text-xs mb-2">
											...
											<div class="flex items-center gap-4 text-xs flex-wrap">
												<span class="text-gray-500">⏱️ ~3-5s</span>
												<span class="text-orange-600 font-medium">💰 Input: $0.005 (Rp 75)</span>
												<span class="text-orange-600 font-medium">💰 Output: $0.005 (Rp 75)</span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="border border-purple-200 rounded-lg p-3 bg-purple-50">
									<div class="flex items-start gap-3">
										...
										<div class="flex-1">
											<h4 class="text-sm font-semibold text-gray-900 mb-1">Cost Calculation & Response</h4>
											<p class="text-xs text-gray-600 mb-2">
												Calculate total token usage and costs in USD and IDR. Return recommendations with full transparency.
											</p>
											<div class="p-2 bg-white border border-purple-200 rounded text-xs">
												<div class="grid grid-cols-2 gap-2 text-gray-700">
													...
													<div>
														...
														<div class="text-green-600 font-medium">88% under budget ✓</div>
													</div>
												</div>
											</div>
											<div class="flex items-center gap-4 text-xs mt-2">
												<span class="text-gray-500">⏱️ Instant</span>
												<span class="text-green-600 font-medium">✓ No API cost</span>
											</div>
										</div>
									</div>
								...
								<div class="flex items-start gap-2">
									...
									<div class="text-xs text-gray-700">
										...
										<p class="text-gray-600">
											Semantic search ensures AI only considers the most relevant items (reducing cost by 80%+),
											while GPT-4o's fashion expertise creates stylistically coherent combinations with detailed reasoning.
											Embeddings are cached to avoid repeated API calls for the same wardrobe.
										</p>
									</div>
								</div>
							</div>
